...
CC      = cc
CFLAGS  = -Wall -Wextra -O2 -I. -Iison -Icrispus

# bibliothecae externae
LIBISON    = ison/libison.a
LIBCRISPUS = crispus/libcrispus.a
...
COMMUNES = tabula.c \
          ...
          cogitatio.c utilia.c fictio.c
COMMUNES_OBJ = $(COMMUNES:.c=.o)

CAPITA  = cellula.h cella.h tabula.h terminalis.h oraculum.h cogitatio.h utilia.h fictio.h \
...
ORACULA_DEP = oracula/provisor.h
...
$(LIBCRISPUS):
	git submodule update --init crispus
	$(MAKE) -C crispus
...
RETIS_DEP = retis/retis.h

retis/retis.o: retis/retis.c $(RETIS_DEP)
	$(CC) $(CFLAGS) -c $< -o $@

retis/serializa.o: retis/serializa.c retis/serializa.h $(RETIS_DEP) $(CAPITA) genera.h
	$(CC) $(CFLAGS) -c $< -o $@

retis/visus.o: retis/visus.c retis/visus.h genera.h cellula.h
	$(CC) $(CFLAGS) -c $< -o $@

# --- curre (sine terminali) ---

curre: curre.o $(COMMUNES_OBJ) oraculum.o $(ORACULA_OBJ) $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^

# --- lude (cum terminali) ---

lude: lude.o terminalis.o $(COMMUNES_OBJ) oraculum.o $(ORACULA_OBJ) $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^
...
fare: fare.o oraculum.o $(ORACULA_OBJ) utilia.o fictio.o $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^
...
proba: proba.o crispus/proba.o $(LIBCRISPUS) utilia.o $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^

proba.o: proba.c crispus/proba.h
	$(CC) $(CFLAGS) -c $< -o $@

crispus/proba.o: crispus/proba.c crispus/proba.h crispus/crispus.h crispus/internum.h crispus/arcana.h
	$(CC) $(CFLAGS) -c $< -o $@

# --- daemonium (servitor TCP) ---

daemonium: daemonium.o retis/retis.o retis/serializa.o $(COMMUNES_OBJ) oraculum.o $(ORACULA_OBJ) $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^

# --- coniunge (cliens interactivus — sine cella.h/tabula.h) ---

CLIENS_OBJ = retis/retis.o retis/cliens.o retis/visus.o retis/crudus.o utilia.o

retis/cliens.o: retis/cliens.c retis/cliens.h $(RETIS_DEP)
	$(CC) $(CFLAGS) -c $< -o $@

retis/crudus.o: retis/crudus.c retis/crudus.h
	$(CC) $(CFLAGS) -c $< -o $@

coniunge: coniunge.o $(CLIENS_OBJ) $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^

coniunge.o: coniunge.c retis/retis.h retis/cliens.h retis/visus.h retis/crudus.h genera.h cellula.h
	$(CC) $(CFLAGS) -c $< -o $@

# --- specta (cliens sine capite — sine cella.h/tabula.h) ---

specta: specta.o $(CLIENS_OBJ) $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^

specta.o: specta.c retis/retis.h retis/cliens.h retis/visus.h genera.h cellula.h
	$(CC) $(CFLAGS) -c $< -o $@

# --- fac_certificatum ---

fac_certificatum: fac_certificatum.o retis/retis.o utilia.o $(LIBCRISPUS) $(LIBISON)
	$(CC) $(CFLAGS) -o $@ $^
...
purga_omnia: purga
	-$(MAKE) -C ison purga
	-$(MAKE) -C crispus purga

.PHONY: omnia purga purga_omnia
